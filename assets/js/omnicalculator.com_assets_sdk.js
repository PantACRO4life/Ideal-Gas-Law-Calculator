    ...
    var a = Array.prototype.forEach,
        ...
        c = {
            container: o(
                o({}, i),
                {},
                { display: "block", margin: 0, padding: 0, fontFamily: "Arial, sans-serif", fontSize: "16px", lineHeight: 1.15, color: "#666", boxSizing: "border-box", background: "#f9f9f9", border: "1px solid #eee", borderRadius: "8px" }
            ),
            header: o(o({}, i), {}, { display: "block", padding: "20px 0", fontSize: "24px", textAlign: "center", background: "#eee", borderTopLeftRadius: "8px", borderTopRightRadius: "8px" }),
            iframe: o(o({}, i), {}, { display: "block", border: "none", width: "100%", margin: 0, padding: 0 }),
            footer: o(o({}, i), {}, { display: "block", marginTop: "16px", marginLeft: "16px", marginBottom: "20px", marginRight: "12px", textAlign: "right" }),
            link: o(o({}, i), {}, { display: "inline", color: "#989c9d", textDecoration: "none", border: 0, boxShadow: "none" }),
            omniImageLink: o(
                o({}, { display: "inline-block", textIndent: "100%", whiteSpace: "nowrap", overflow: "hidden" }),
                {},
                { width: "51px", height: "13px", background: "url(https://cdn.omnicalculator.com/images/omni-db2e5a9837.svg)", backgroundRepeat: "no-repeat" }
            ),
    ...
    !(function (e, r) {
        if (!e.OmniC) {
            ...
            (n = function () {
                ...
                "loading" !== r.readyState ? n() : r.addEventListener("DOMContentLoaded", n),
                ...
                if (s && n) {
                    ...
                    if (p) {
                        ...
                        (v.className = "omni-calculator-frame"),
                            ...
                            (v.src = t + "/embed/" + p + "#id=" + b + "&hasLink=" + y + "&version=" + h),
                            u(v, c.iframe),
                            (v.style.height = "0"),
                            e.insertBefore(v, s);
                    ...
                    switch (p.type) {
                        ...
                        case "LOADED":
                            return void (function (e) {
                                ...
                                })(r, { type: "CONFIG", config: o, currency: a, showRowControls: "false" !== c });
                            })(p);
                        case "READY":
